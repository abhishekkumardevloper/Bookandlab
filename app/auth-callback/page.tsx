    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-slate-50 text-slate-800 p-4 text-center">
        <div>
          ...
          <Link href="/handler/sign-out" className="text-indigo-600 font-bold hover:underline">
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-50 text-slate-800 p-4 text-center">
      <div>
        ...
        <Link href="/handler/sign-out" className="px-4 py-2 bg-indigo-600 text-white rounded font-bold">
          Clear Session
        </Link>
      </div>
    </div>
